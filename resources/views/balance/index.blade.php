@extends('app', [
    'title' => __('Balance replenishment'),
    ...
    <form action="{{ route('payment.create') }}" method="POST" class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td colspan="6" class="px-6 py-4">
                                    <div class="p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                                        <span class="font-medium">{{ __('Empty') }}!</span> {{ __('There are no replenishments') }}.
                                    </div>
                                </td>
                            </tr>
                            @endforelse
            ...
            <div class="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
                <div class="space-y-4">
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white">{{ __('Balance replenishment') }}</h2>

                    <input type="number" name="amount" id="amount" value="{{ old('amount') }}" placeholder="{{ __('Enter the amount') }}" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" required>
                        ...
                        <li>
                            ...
                            <label for="yookassa" class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">                           
                                <div class="block">
                                    ...
                                    <div class="w-full text-sm font-medium">{{ __('Commission') }} 0%</div>
                                </div>
                    ...
                    <button type="submit" class="flex w-full items-center justify-center rounded-lg text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">{{ __('Top up balance') }}</button>
                </div>
            </div>
        </div>
    </form>
